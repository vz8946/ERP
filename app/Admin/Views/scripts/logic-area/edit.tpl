...
<div class="title">{{if $action eq 'edit'}}编辑逻辑区{{else}}添加逻辑区{{/if}}</div>
<div class="content">
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_form">
<tbody>
    <tr> 
      <td width="10%"><strong>逻辑区名称</strong> * </td>
      <td><input type="text" name="name" size="30" value="{{$data.name}}" msg="请填写逻辑区名称" class="required" /></td>
    </tr>
    <tr>
