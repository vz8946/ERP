...
<div class="login-box">
  ...
  <div class="user-code"><img class="auth-image" src="{{url param.action=auth-image param.space=adminLogin}}" alt="verifyCode" border="0" onclick= this.src="{{url param.action=auth-image param.space=adminLogin param.code=}}"+Math.random() style="cursor: pointer;" title="点击更换验证码" /></div>
