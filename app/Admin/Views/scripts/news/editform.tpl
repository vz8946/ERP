...
<tbody>
   ...
   <tr>
      ...
      <td><input type="text" name="article[seoKeywords]" size="30" value="{{$article.seoKeywords}}" /></td>
    </tr>
    <tr>
      <td width="10%"><strong>meta描述</strong> * </td>
      <td><textarea name="article[seoDescription]" rows="5" cols="45" id="seoDescription" style="width:330px; height:45px;">{{$article.seoDescription}}</textarea></td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td>
			<input name="article[position]" id="position1" value="{{$article.position}}" size="50" readonly /> <input type="button" onclick="clearPosition();" value="删除最后一个" />
		</td>
	</tr>
    <tr>
