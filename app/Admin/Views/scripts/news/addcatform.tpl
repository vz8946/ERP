...
<tbody>
    ...
    <tr>
      ...
      <td><input type="text" name='cat[name]' size="30" msg="请填写名称" class="required" /></td>
    </tr>
    <tr>
      <td width="10%"><strong>别名</strong> * </td>
      <td><input type="text" name='cat[asName]' size="30" msg="请填写别名" class="required" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="cat[title]" size="60" /></td>
    </tr>
    <tr>
      <td width="10%"><strong>meta关键字</strong> * </td>
      <td><input type="text" name="cat[keywords]" size="60" /></td>
    </tr>
    <tr>
      <td width="10%"><strong>meta描述</strong> * </td>
      <td><textarea name="cat[description]" rows="3" cols="39" id="description" style="width:450px; height:60px;"></textarea></td>
    </tr>
</tbody>
</table>
</div>
