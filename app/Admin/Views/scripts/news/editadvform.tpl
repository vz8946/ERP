...
<input type='hidden' name='adv[id]' value='{{$adv.id}}'>
...
<tbody>
    <tr>
      ...
      <td><input type="text" name="adv[name]" size="50" value="{{$adv.name}}" msg="请填写标题" class="required" /></td>
    </tr>
    <tr>
      <td width="10%"><strong>着陆地址</strong> * </td>
      <td><input name="adv[url]" type="text" id="url" value="{{$adv.url}}" size="50" msg="请填写着陆地址" class="required" /></td>
    </tr>
    <tr>
	...
	<tr>
	  <td></td>
	  <td>原图：<img src="{{$imgBaseUrl}}/{{$adv.imgUrl}}" width="100" height="100" /></td>
	</tr>
	{{/if}}
   <tr>
      <td width="10%"><strong>是否展示</strong> </td>
      <td><select name="adv[isDisplay]">
      		<option value="1" {{if $adv.isDisplay eq 1}}selected="selected"{{/if}}>展示</option>
      		<option value="0" {{if $adv.isDisplay eq 0}}selected="selected"{{/if}}>隐藏</option>
      </select></td>
    </tr>
    <tr>
      <td width="10%"><strong>优先级</strong> </td>
      <td><input name="adv[grade]" type="text" id="url" value="{{$adv.grade}}" size="30" /></td>
    </tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<input name="adv[position]" id="position1" value="{{$adv.position}}" size="50" readonly /> <input type="button" onclick="clearPosition();" value="删除最后一个" />
		</td>
	</tr>
	<tr>
      <td width="10%"><strong>市场价格</strong> </td>
      <td><input name="adv[market_price]" type="text" id="url" value="{{$adv.market_price}}" size="30" /></td>
    </tr>
	<tr>
      <td width="10%"><strong>价格</strong> </td>
      <td><input name="adv[price]" type="text" id="url" value="{{$adv.price}}" size="30" /></td>
    </tr>
