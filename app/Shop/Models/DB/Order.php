...
class Shop_Models_DB_Order
{
    ...
    public function getOrderBatch($where=null)
    {
        ...
        if ($condition) {
            $sql = "SELECT a.order_id,a.user_id,a.user_name,a.invoice_type,a.invoice,a.invoice_content,a.parent_id,a.parent_param,a.proportion,a.warehouse_id,a.licence,a.Tariff,";
	...
	public function getWareHouseINfoByWareHouseId($warehouse_id){
		$sql = "select w.warehouse_name,p.area_name as province_name,c.area_name as city_name,d.area_name as district_name from shop_warehouse w left join shop_area p on w.province_id = p.area_id left join shop_area c on w.city_id = c.area_id left join shop_area d on w.district_id = d.area_id where w.warehouse_id = '$warehouse_id'";
