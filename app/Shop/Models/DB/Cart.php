...
//		$sql = "select * from shop_warehouse";
		$sql = "select w.*,p.area_name as province_name,c.area_name as city_name,d.area_name as district_name from shop_warehouse w left join shop_area p on w.province_id = p.area_id left join shop_area c on w.city_id = c.area_id left join shop_area d on w.district_id = d.area_id";
		return $this->_db->fetchAll($sql);
	}
}