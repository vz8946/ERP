<div class="floor floor_1">
	<div class="col-l fl w2">
		<div class="col-l-1 fl" style="width: 222px;overflow: hidden;">
			<h3 style="background: {{$bg_color}};"><span><img alt="{{$floor_icon.0.title}}" _src="{{$imgBaseUrl}}/{{$floor_icon.0.img}}"/></span>{{$floor_name}}</h3>
			<div class="adv"><a href="{{$floor_adv.0.url}}"><img alt="{{$floor_adv.0.title}}" _src="{{$imgBaseUrl}}/{{$floor_adv.0.img}}"/></a></div>
		</div>
		<div class="col-l-2 fl tab floor-tab" style="width: 668px;padding-left:10px;">
			...
			<div class="tab-c" style="border:3px solid{{$bg_color}};">
				<div>
		...
		<div class="goods-hot">
			...
			<ul>
				...
				<li>
					...
					<div class="p-title">{{$v.goods_name|default:$v.goods.goods_name}}</div>
				</li>
				{{/foreach}}
			</ul>
		</div>
