...
<div class="wbox">
	<div class="position">
		<b><a href="/try.html">试用中心</a></b><span> &gt; 正在进行的试用活动 </span>
	</div>
	<div class="wrap clearfix">
		...
		<div class="trialin clearfix">
			<div class="toolbar">
				<div class="tl">
					<a href="/trying{{$pid}}.html">&lt;&lt; <b>上一产品</b> </a>
					<a href="/trying{{$nid}}.html"><b>下一产品</b> &gt;&gt;</a>
				</div>
			</div>
			<div class="title">
				<p>
			...
			<div class="form clearfix">
				...
				<div class="frame">
					<div class="applyCon">
						...
						<ul>
							<li>
								申请日期：{{$r.start_time|date_format:'%Y-%m-%d'}} 至  {{$r.end_time|date_format:'%Y-%m-%d'}}
							</li>
							<li time="1217745" id="trial-daojishi">
								<p>
									剩余时间：
								</p>
