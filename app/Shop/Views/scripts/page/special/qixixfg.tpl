<style type="text/css">
	* {
	...
	.bgimg {
		...
		background-image: url('/images/special/qixi/bg-man.jpg');
...
<div class="bgimg">
	<div  class="zqj_box">
		<div id="biyuntao-hd02">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd02.jpg" width="990" height="80" alt="">
		</div>
		<div id="biyuntao-hd04">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd04.jpg" width="990" height="80" alt="">
		</div>
		<div id="biyuntao-hd05">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd05.jpg" width="990" height="80" alt="">
		</div>
		<div id="biyuntao-hd06">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd06.jpg" width="990" height="80" alt="">
		</div>
		<div id="biyuntao-hd07">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd07.jpg" width="990" height="80" alt="">
		</div>
		<div id="biyuntao-hd08">
			<img src="{{$imgBaseUrl}}/images/special//sex-hd/biyuntao-hd08.jpg" width="990" height="68" alt="">
		</div>
		<div class="floor" style="padding-bottom: 20px;">
			{{html type="wdt" id="special_qixixfg_floor"}}
		</div>
		<div  class="aaa"></div>
	</div>
</div>
