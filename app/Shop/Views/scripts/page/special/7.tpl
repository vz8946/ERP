...
<style>
	...
	.topic-body {
		background: url('/images/special/7/bg.jpg') no-repeat center 0px;
		width: 990px;
		margin: 0px auto;
		overflow: hidden;
	}
	...
	<div class="topic-body">
		<div class="topic-main">
			<div style="padding-top:580px;overflow: hidden;">
				...
				<div><img src="/images/special/7/bg2.jpg"/></div>
				<div style="height: 10px;overflow: hidden;"></div>
				
				<div id="p3"><img src="/images/special/7/t4.jpg"/></div>
				{{html type="wdt" id="special_7_floor_4"}}
				<div style="height: 10px;overflow: hidden;"></div>

				<div id="p2"><img src="/images/special/7/t3.jpg"/></div>
				{{html type="wdt" id="special_7_floor_3"}}
				<div style="height: 10px;overflow: hidden;"></div>
