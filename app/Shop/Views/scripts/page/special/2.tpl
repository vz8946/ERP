<style>
	...
	.topic-container {
		background: url('/images/special/2/bg-main.png') #E6E6E6 repeat-x center 0px;
		padding-bottom: 20px;
	}
	.topic-body {
		width: 990px;
...
<div class="topic-container">
	<div class="topic-body">
		<a target="_blank" href="http://www.1jiankang.com/zt/detail-62.html" style="width: 220px;height: 80px;position: absolute;top: 400px;right:185px;"></a>
		<div class="topic-main">
			<div><img src="{{$imgBaseUrl}}/images/special/2/bg-banner.jpg"/>
			</div>
			<div><img src="{{$imgBaseUrl}}/images/special/2/tip.jpg"/>
			</div>
			<div class="wrp-quan" >
				<a class="quan quan-10" onclick="quan_bind('{{$quan10.sn}}','{{$quan10.pwd}}');" href="javascript:void(0);"></a>
				<a class="quan quan-30" onclick="quan_bind('{{$quan30.sn}}','{{$quan30.pwd}}');" href="javascript:void(0);"></a>
				<a class="quan quan-50" onclick="quan_bind('{{$quan50.sn}}','{{$quan50.pwd}}');" href="javascript:void(0);"></a>
			</div>
			<div>
				{{html type="wdt" id="special_2_floor"}}
