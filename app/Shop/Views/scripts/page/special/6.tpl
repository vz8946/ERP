<style>
	...
	.topic-container {
		background: url('/images/special/6/bg-topic-body.jpg') #fff no-repeat center 0px;
		padding-bottom: 20px;
	}
	...
	<div class="topic-body">
		<div class="topic-main">
			<div style="padding-top:580px;overflow: hidden;">
				...
				<div><img src="/images/special/6/div-yryy.jpg"/></div>
				{{html type="wdt" id="special_6_floor_yryy"}}
				<div style="height: 30px;overflow: hidden;"></div>
				
				<div><img src="/images/special/6/div-bxyx.jpg"/></div>
				{{html type="wdt" id="special_6_floor_bxyx"}}
				<div style="height: 30px;overflow: hidden;"></div>

				<div><img src="/images/special/6/div-gnq.jpg"/></div>
				{{html type="wdt" id="special_6_gnq"}}
				<div style="height: 30px;overflow: hidden;"></div>
				
				<div><img src="/images/special/6/div-jfss.jpg"/></div>
				{{html type="wdt" id="special_6_jfss"}}
