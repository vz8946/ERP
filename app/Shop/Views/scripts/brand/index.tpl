...
<div class="position"><b><a href="/">垦丰商城</a></b> &gt; <a href="/brand.html">品牌馆</a> &gt; <a href="/b-{{$brand.as_name}}/" title="{{$brand.brand_name}}">{{$brand.brand_name}}</a> </div>
<!-- 左侧导航信息 -->
...
<!-- 产品列表 -->
    <div class="list-bar">排序：
    	{{if $orderby eq 'time' }}
    		 <a rel="nofollow" href="/b-{{$brand.as_name}}/sort-time-{{if $asc eq 'asc'}}desc{{else}}asc{{/if}}.html" class="all_screen" title="上架时间">上架时间 <span class="product-{{if $asc eq 'asc'}}asc{{else}}desc{{/if}}"></span></a>
    	{{else}}
    		 <a rel="nofollow" href="/b-{{$brand.as_name}}/sort-time-asc.html" class="all_screen_off" title="上架时间">上架时间 <span class="product-asc"></span></a>
    	{{/if}}
    	{{if $orderby eq 'price' }}
    		 <a rel="nofollow" href="/b-{{$brand.as_name}}/sort-price-{{if $asc eq 'asc'}}desc{{else}}asc{{/if}}.html" class="all_screen" title="价格">价格 <span class="product-{{if $asc eq 'asc'}}asc{{else}}desc{{/if}}"></span></a>
    	{{else}}
			 <a rel="nofollow" href="/b-{{$brand.as_name}}/sort-price-asc.html" class="all_screen_off" title="价格">价格 <span class="product-asc"></span></a>
    	{{/if}}
	</div>
