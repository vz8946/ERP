...
<div class="content">
	<div class="flow_step">
    	<span class="logo"><img width="225" height="101" src="{{$_static_}}/images/cart/logo.jpg"></span>
        <ul>
...
<div class="pay_success">
    	<table width="414" cellspacing="0" cellpadding="0" border="0">
          <tbody><tr>
            <td valign="top" align="right" rowspan="5"><img width="52" height="45" src="{{$_static_}}/images/cart/icon_success.jpg"></td>
