...
<link href="/Public/css/promotion.css" rel="stylesheet" type="text/css" />
<div class="discount" style="margin: 10px auto 0;width: 990px;">
{{$top.content}}
...
<script type="text/jscript" src="{{$imgBaseUrl}}/Public/js/jquery-1.4.2.min.js"></script>
