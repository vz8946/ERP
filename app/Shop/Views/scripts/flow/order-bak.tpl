   ...
   {{if $product.canNotUseCard neq 1}}
       ...
       {{if $gift_infos}}
         <div id="gift-card-box" class="none"> 
           <h3 rel="list-gift-card-box"><i></i>使用已绑定垦丰卡 （{{$gift_infos|@count}}张）<span>使用垦丰卡更优惠，如何购买垦丰卡？</span></h3>       
        <div id="list-gift-card-box" class="pay_box pay_card">
    ...
    {{/if}}     
      ...
      <h3 rel="bind-gift-card-box"><i></i>使用未绑定垦丰卡</h3>
      <div id="bind-gift-card-box" class="pay_box pay_card pay_card_unbind">
        	<table width="730" cellspacing="0" cellpadding="0" border="0">
              <tbody><tr>
                ...
                <td width="*"><a class="btn_use" href="javascript:;" onclick="checkCard('card_id', 'card_password', this)">确定使用</a></td>
