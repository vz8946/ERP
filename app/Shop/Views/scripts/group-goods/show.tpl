			...
			<div class="goods_comment">
				...
				<form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
					...
					<div class="grayborder" style="margin-top:10px;">
						<textarea name="content" id="content"  style="width: 986px; height: 73px;"></textarea>
					</div>
					<div class="tj">
	...
	<div class="look"  id='bfd_bab'>
		...
		<ul class="">
			...
			<li>
				...
				<a onclick="addCart('{{$goods.product_sn}}','buy',1)" href="javascript:void(0);" class="buybtn"><img src="{{$imgBaseUrl}}/images/shop/fenlei_r14_c5.jpg"></a>
			</li>
			{{/foreach}}
			<div style="clear:both;"></div>
		</ul>
