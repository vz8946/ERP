...
class GoodsController extends Zend_Controller_Action
{
	...
	//积温带过滤配置	
    private $_filter_characters = array(
        array(
			'characters_value'=> 1,
            'characters_name'=>'第一积温带'
        ),
        array(
			'characters_value'=> 2,
            'characters_name'=>'第二积温带'
        ),
        array(
			'characters_value'=> 3,
            'characters_name'=>'第三积温带'
        ),
        array(
			'characters_value'=> 4,
            'characters_name'=>'第四积温带'
        ),
        array(
			'characters_value'=> 5,
            'characters_name'=>'第五积温带'
        ),
        array(
			'characters_value'=> 6,
            'characters_name'=>'第六积温带'
        ),
    );
