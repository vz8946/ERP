...
<div class="{{if $is_index_page}}wbox_1200{{else}}wbox990{{/if}} footer" style="padding-top: 10px;clear:both;">
  <div class="helper">
     <dl class="fore1">
       ...
       <dd><a href="/help/detail-24.html">购物指南</a></dd>
       <dd><a href="/help/detail-2.html">会员制度</a></dd>
       <dd><a href="/help/detail-3.html">积分获取与使用</a></dd>
       <dd><a href="/help/detail-4.html">售后服务</a></dd>
     </dl>
     <dl class="fore2">
  ...
  <div class="menu">
   ...
   <div class="copyright">垦丰商城 All Rights Reserved 2015  垦丰商城 <br>
    ICP证:<a rel="nofollow" target="_blank" href="http://www.miibeian.gov.cn/"> 沪ICP备10200022号-3 </a><br>
   </div>
</div>
