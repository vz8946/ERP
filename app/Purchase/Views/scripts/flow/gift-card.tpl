    ...
    <div class="pay_method">
        ...
        <div class="pay_bank">      
          ...
          {{foreach from=$payment.bank_list key=key  item=bank_list}}
           ...
           <img src="{{$bank_list.img_url}}" width="120"  /></li>
          {{/foreach}} 
          </ul>
        </div>
          {{/if}}
    ...
    <div class="bill">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <div class="op_bill">
            ...
            <span>应付合计：<em>{{$products.amount|number_format:2}}</em>元&nbsp;<a id="onSubmit"  href="javascript:;" onClick="$('#myform').submit();"><img src="{{$_static_}}/images/cart/btn_card_pay.jpg"  /></a></span>
        </div>
    </div>
    <!--商品清单 end---->
    </div>
