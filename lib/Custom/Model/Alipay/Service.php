...
class Custom_Model_Alipay_Service {
    ...
    function Custom_Model_Alipay_Service($aliapy_config) {
	...
	function alipay_auth_authorize($para_temp) {
		...
		//$button_name = "确认";
		//生成表单提交HTML文本信息
		$alipaySubmit = new Custom_Model_Alipay_Submit();
