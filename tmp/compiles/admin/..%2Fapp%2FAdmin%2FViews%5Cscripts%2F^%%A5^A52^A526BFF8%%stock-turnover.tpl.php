<?php /* Smarty version 2.6.19, created on 2014-10-24 15:06:19
         compiled from data-analysis/stock-turnover.tpl */ ?>
...
" />
    周转基数(天)：<input name="days" id="days" type="text"  size="2" value="<?php echo $this->_tpl_vars['param']['days']; ?>
" />
    <select name="type">
      <option value="">周转率</option>
      <option value=">=" <?php if ($this->_tpl_vars['param']['type'] == '>='): ?>selected<?php endif; ?>>周转率大于</option>
      <option value="<" <?php if ($this->_tpl_vars['param']['type'] == '<'): ?>selected<?php endif; ?>>周转率小于</option>
    </select>
    <input name="rate" id="rate" type="text"  size="2" value="<?php echo $this->_tpl_vars['param']['rate']; ?>
" />
...
<div class="title">产品库存周转率列表 [<a href="<?php echo $this -> callViewHelper('url', array(array('todo'=>'export',)));?>" target="_blank">导出信息</a>]</div>
	<div class="content">
...
?>
		...
		<tr>
		  ...
		  <td ><?php echo $this->_tpl_vars['total']['StockNumber']; ?>
</td>
		  <td ><?php echo $this->_tpl_vars['total']['Rate']; ?>
</td>
	    </tr>
		</thead>
		<?php endif; ?>
