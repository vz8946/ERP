<?php /* Smarty version 2.6.19, created on 2014-10-23 15:00:33
...
<tbody>
    ...
    <tr> 
      ...
      <td><input type="text" name="staff_price" size="8" value="<?php echo $this->_tpl_vars['data']['staff_price']; ?>
" msg="请填写员工价" class="required" /></td>
    </tr>
    -->
    <tr>
      <td width="10%"><strong>市场价</strong> * </td>
      <td><input type="text" name="market_price" size="8" value="<?php echo $this->_tpl_vars['data']['market_price']; ?>
" msg="请填写市场价" class="required" /></td>
    </tr>
    <tr> 
      <td width="10%"><strong>本店价</strong> * </td>
      <td><input type="text" name="price" id="price" size="8" value="<?php echo $this->_tpl_vars['data']['price']; ?>
" msg="请填写本店价" class="required" onchange = "changePrice('<?php echo $this->_tpl_vars['data']['price_limit']; ?>
', this)"/></td>
    </tr>
    <tr> 
...
function check()
{
    ...
    var price_limit = '<?php echo $this->_tpl_vars['data']['price_limit']; ?>
';
