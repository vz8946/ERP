<?php /* Smarty version 2.6.19, created on 2014-10-27 14:31:14
...
"><?php echo $this->_tpl_vars['s']['supplier_name']; ?>
    ...
    <tr>
      <td colspan="2">
      <input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('controller'=>'product','action'=>'sel','type'=>'sel_status','logic_area'=>$this->_tpl_vars['logic_area'],)));?>/sid/'+$('supplier_id').value,'ajax','查询商品',750,400);" value="查询添加商品">
