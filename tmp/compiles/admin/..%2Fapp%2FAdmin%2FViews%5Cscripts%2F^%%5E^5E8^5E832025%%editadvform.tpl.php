<?php /* Smarty version 2.6.19, created on 2014-10-24 19:30:59
         compiled from news/editadvform.tpl */ ?>
<style type="text/css">
...
<input type='hidden' name='adv[id]' value='<?php echo $this->_tpl_vars['adv']['id']; ?>
'>
...
" size="50" msg="请填写着陆地址" class="required" /></td>
	...
	<?php if ($this->_tpl_vars['adv']['imgUrl']): ?>
	<tr>
	  <td></td>
	  <td>原图：<img src="<?php echo $this->_tpl_vars['imgBaseUrl']; ?>
/<?php echo $this->_tpl_vars['adv']['imgUrl']; ?>
" width="100" height="100" /></td>
   ...
   <tr>
      ...
      <td><select name="adv[isDisplay]">
      		<option value="1" <?php if ($this->_tpl_vars['adv']['isDisplay'] == 1): ?>selected="selected"<?php endif; ?>>展示</option>
      		<option value="0" <?php if ($this->_tpl_vars['adv']['isDisplay'] == 0): ?>selected="selected"<?php endif; ?>>隐藏</option>
      </select></td>
    </tr>
    <tr>
