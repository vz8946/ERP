<?php /* Smarty version 2.6.19, created on 2014-10-23 08:45:08
         compiled from admin/change-password.tpl */ ?>
<form name="myForm" id="myForm"  method="post"  action="<?php echo $this -> callViewHelper('url', array(array('action'=>$this->_tpl_vars['action'],)));?>"  target="ifrmSubmit" >
