<?php /* Smarty version 2.6.19, created on 2014-10-27 14:10:22
         compiled from category/relation.tpl */ ?>
<form name="myForm" id="myForm" action="<?php echo $this -> callViewHelper('url', array(array('action'=>"relation-save",)));?>" method="post" target="ifrmSubmit"/>
<input type="hidden" value="<?php echo $this->_tpl_vars['id']; ?>
" name="id"/>
<input type="hidden" value="<?php echo $this->_tpl_vars['type']; ?>
" name="type"/>
<input type="hidden" value="<?php echo $this->_tpl_vars['limit_type']; ?>
" name="limit_type"/>
<div class="content">
    <div>
   <input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('controller'=>'goods','action'=>'sel',)));?>','ajax','查询商品',750,450,true,'sel');" value="查询添加商品">
...
<tbody id="list">
<?php $_from = $this->_tpl_vars['list_relation']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
