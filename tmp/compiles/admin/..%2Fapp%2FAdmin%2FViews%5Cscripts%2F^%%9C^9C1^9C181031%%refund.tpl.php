<?php /* Smarty version 2.6.19, created on 2014-10-23 10:52:31
         compiled from member/refund.tpl */ ?>
...
<div class="ui-layout-center">
	<div class="ui-layout-content">
		<div class="panel" style="padding:20px;">
			...
			>
				<input type="hidden" value="<?php echo $this->_tpl_vars['r']['member_id']; ?>
" name="id"/>
				<table class="tbl-frm">
					<tr>
						<th width="100">昵称：</th>
						<td><?php echo $this->_tpl_vars['r']['nick_name']; ?>
</td>
					</tr>
					<tr>
						<th>账户邮箱：</th>
					...
					<tr>
						<th>账户余额：</th>
						<td><?php echo $this->_tpl_vars['r']['money']; ?>
</td>
					</tr>
					<tr>
						<th>冻结余额：</th>
						<td><?php echo $this->_tpl_vars['r']['frost_money']; ?>
</td>
					</tr>
					<tr>
						<th>退款金额：</th>
