<?php /* Smarty version 2.6.19, created on 2014-11-18 03:23:46
         compiled from brand/error.tpl */ ?>
<div style="clear: both; padding: 50px 0;  text-align: center; font-size: 14px; font-weight: bold; color: #ff0000;">
    <?php if ($this->_tpl_vars['type'] == '500'): ?>
        您访问的页面暂时无法访问,请稍候重试
    <?php else: ?>
      <a href="/" ><img src="<?php echo $this->_tpl_vars['imgBaseUrl']; ?>
/images/page404.jpg" border="0" width="400px" /></a>
		  <!--这里定义倒计时开始数值-->
		  	  
		  <p>	</p>
		  	  
		  <p>	
		   <div style="font-family:'微软雅黑'; font-size:20px; color:#a8a5a5; text-align:center; width:510px;">404错误，你访问的页面不存在</div>	  
		   </p>
