<?php /* Smarty version 2.6.19, created on 2014-10-30 12:30:55
         compiled from member/avatar.tpl */ ?>

<link href="<?php echo $this->_tpl_vars['_static_']; ?>
/css/jquery.Jcrop.css" media="all" rel="stylesheet" type="text/css" />
<link href="<?php echo $this->_tpl_vars['_static_']; ?>
/css/jquery.Jcrop.min.css" media="all" rel="stylesheet" type="text/css" />
...
/images/shop/member_avatar.png"></div>
		<?php if ($this->_tpl_vars['member']['photo']): ?>
		<div style="padding:20px;line-height:30px;">
			<span style="color:#333;font-size:14px;font-weight:bold;">当前我的头像</span>
			<br />
			<img alt="我的头像" src="<?php echo $this->_tpl_vars['imgBaseUrl']; ?>
/<?php echo $this->_tpl_vars['member']['photo']; ?>
" width="80" />
		</div>
		<?php endif; ?>
...
/images/shop/avata_demo.jpg" id="target" alt="我的头像"/>
			</div>
			<br />
		</div>
...
<script>
    ...
    $('#pic').uploadify({
        ...
        width:100,
        height:20,
        formData:{ssid:'<?php echo $this->_tpl_vars['ssid']; ?>
'},
        transparent: false,
        onUploadSuccess : function(file, data, response){
        	...
        	if(data.path=="" || data.path==null){
        		...
        		if(parseInt(data.width)>parseInt(data.height)){
        			...
        			$('#target-box').html('<img src="<?php echo $this->_tpl_vars['imgBaseUrl']; ?>
/'+data.path+'" width="300" id="target" alt="我的头像"/>');
        		}
        		else{
        			bilv=parseInt(data.height)/300;
        			$('#target-box').html('<img src="<?php echo $this->_tpl_vars['imgBaseUrl']; ?>
/'+data.path+'" height="300" id="target" alt="我的头像"/>');
        		}
        		$("#bilv").val(bilv);
        		setJcrop();
